...
// @public (undocumented)
export function appliedMigrations(driver: Driver): Promise<MigrationRecord[]>;
...
export class Db implements QueryExecutor {
    ...
    pendingMigrations(dir?: string): Promise<PendingMigration[]>;
...
// @public
export function diffSchema(driver: Driver, entities: readonly RegisteredEntity[]): Promise<DiffAction[]>;

// @public
export function distinct<T>(_field: T): T;

// @public (undocumented)
export function downMigration(driver: Driver, dir: string, name: string): Promise<void>;
...
// @public
export interface EntityClass<_TTable extends string, TSchema extends Record<string, string>, TRels extends RelationsMap = {}> extends AnyEntityClass {
...
//
// @public
export type EntityInstance<E extends AnyEntityClass> = E extends new (...args: any[]) => infer R ? R extends EntityBase ? R : EntityInstanceFromTable<E> : EntityInstanceFromTable<E>;
...
// @public
export type ExtractSQLBase<S extends string> = StripParens<S> extends `${infer Base} ${string}` ? Lowercase<Base> : Lowercase<StripParens<S>>;
...
// @public
export type InferColumnType<S extends string> = IsNotNull<S> extends true ? SQLToTS<S> : SQLToTS<S> | null;
...
// @public
export type IsGenerated<S extends string> = Lowercase<S> extends `${string}autoincrement${string}` ? true : Lowercase<S> extends `${string}auto_increment${string}` ? true : Lowercase<S> extends `${string}generated${string}` ? true : Lowercase<ExtractSQLBase<S>> extends "serial" | "bigserial" ? true : false;

// @public
export type IsNotNull<S extends string> = Lowercase<S> extends `${string}not null${string}` ? true : Lowercase<S> extends `${string}primary key${string}` ? true : false;
...
// @public
export type ManyToMany<E extends AnyEntityClass | EntityBase> = E extends EntityBase ? ManyRelation<E> : RelatedEntityInstance<EntityClassOf<E>, "many">;

// @public
export function manyToMany<E extends AnyEntityClass>(target: () => E, options: JunctionOptions): RelationDef<E, "many-to-many">;

// @public
export function manyToMany<TTarget>(target: () => {
    _selectType: TTarget;
}, options: JunctionOptions): RelationDef<TTarget, "many-to-many">;

// @public
export function manyToMany<E extends AnyEntityClass>(target: () => unknown, options: JunctionOptions): RelationDef<E, "many-to-many">;
...
// @public
export function manyToOne<E extends AnyEntityClass>(target: () => E, options: RelationOptions): RelationDef<E, "many-to-one">;

// @public
export function manyToOne<TTarget>(target: () => {
    _selectType: TTarget;
}, options: RelationOptions): RelationDef<TTarget, "many-to-one">;

// @public
export function manyToOne<E extends AnyEntityClass>(target: () => unknown, options: RelationOptions): RelationDef<E, "many-to-one">;
...
// @public
export type MaterializeShape<T extends Record<string, unknown>> = T extends Record<string, string> ? Materialized<T> : Mutable<T>;
...
// @public
export function migrationStatus(driver: Driver, dir: string): Promise<{
    applied: MigrationRecord[];
    pending: string[];
}>;
...
// @public
export type OneToMany<E extends AnyEntityClass | EntityBase> = E extends EntityBase ? ManyRelation<E> : RelatedEntityInstance<EntityClassOf<E>, "many">;

// @public
export function oneToMany<E extends AnyEntityClass>(target: () => E, options: {
    foreignKey: string | string[];
}): RelationDef<E, "one-to-many">;

// @public
export function oneToMany<TTarget>(target: () => {
    _selectType: TTarget;
}, options: {
    foreignKey: string | string[];
...
// @public
export function oneToMany<E extends AnyEntityClass>(target: () => unknown, options: {
    foreignKey: string | string[];
}): RelationDef<E, "one-to-many">;
...
// @public
export function oneToOne<E extends AnyEntityClass>(target: () => E, options: RelationOptions): RelationDef<E, "one-to-one">;

// @public
export function oneToOne<TTarget>(target: () => {
    _selectType: TTarget;
}, options: RelationOptions): RelationDef<TTarget, "one-to-one">;

// @public
export function oneToOne<E extends AnyEntityClass>(target: () => unknown, options: RelationOptions): RelationDef<E, "one-to-one">;

// @public
export type OneToOneDef<E> = RelationDef<E, "one-to-one">;

// @public
export type OptionalOnInsert<S extends string> = IsGenerated<S> extends true ? true : IsNotNull<S> extends false ? true : HasDefault<S> extends true ? true : false;
...
// @public (undocumented)
export function pendingMigrations(driver: Driver, dir: string): Promise<PendingMigration[]>;
...
// Warning: (ae-forgotten-export) The symbol "NoCtes" needs to be exported by the entry point index.d.ts
// Warning: (ae-forgotten-export) The symbol "QueryFromKind" needs to be exported by the entry point index.d.ts
//
// @public
export class QueryBuilder<C extends AnyEntityClass = AnyEntityClass, T = EntityInstance<C>, Ctes extends Record<string, unknown> = NoCtes, FromKind extends QueryFromKind = "table"> {
    ...
    // (undocumented)
    fullJoin<E extends AnyEntityClass>(entity: E, on: (joined: EntityInstance<E>, row: T) => boolean): this;
    groupBy(columnOrFn: string | string[] | number | number[] | ((row: EntityInstance<C>) => unknown), ...rest: (string | number)[]): this;
    having(predicate: HasRegisteredCtes<Ctes> extends true ? (row: EntityInstance<C>, ctes: RegisteredCtes<Ctes>) => boolean : (row: EntityInstance<C>) => boolean, params?: Record<string, unknown>): this;
    innerJoin(keysOrFn: string[] | ((row: T) => unknown)): this;
    // (undocumented)
    innerJoin<E extends AnyEntityClass>(entity: E, on: (joined: EntityInstance<E>, row: T) => boolean): this;
    ...
    // (undocumented)
    leftJoin<E extends AnyEntityClass>(entity: E, on: (joined: EntityInstance<E>, row: T) => boolean): this;
    limit(n: number): this;
    ...
    where(predicate: FromKind extends "cte" ? (row: T) => boolean : HasRegisteredCtes<Ctes> extends true ? (row: TableRow<C, T, FromKind>, ctes: RegisteredCtes<Ctes>) => boolean : (row: TableRow<C, T, FromKind>) => boolean, params?: Record<string, unknown>): this;
    // (undocumented)
    withCte<const N extends string, IC extends AnyEntityClass, IT>(name: N, subquery: QueryBuilder<IC, IT, any, any>): QueryBuilder<C, T, Ctes & Record<N, IT>, FromKind>;
    // (undocumented)
    withCte<const N extends string, IC extends AnyEntityClass, IT>(name: N, build: (ctes: RegisteredCtes<Ctes>) => QueryBuilder<IC, IT, any, any>): QueryBuilder<C, T, Ctes & Record<N, IT>, FromKind>;
    withRecursiveCte<const N extends string, IC extends AnyEntityClass, IT>(name: N, subquery: QueryBuilder<IC, IT, any, any>): QueryBuilder<C, T, Ctes & Record<N, IT>, FromKind>;
}
...
// @public
export type RelatedEntityInstance<E extends AnyEntityClass, Kind extends "one" | "many"> = Kind extends "many" ? RelationQueryBuilder<SelectRow<E>> & EntityInstance<E>[] : SingleRelation<EntityInstance<E>>;
...
// @public
export type RelationKind<TType extends RelationType> = TType extends "one-to-many" | "many-to-many" ? "many" : "one";

// @public
export type RelationLoadedValue<R> = R extends RelationDef<infer E, infer TType> ? E extends AnyEntityClass ? unknown extends E ? TType extends "one-to-many" | "many-to-many" ? RelationQueryBuilder<any> & EntityBase[] : EntityBase : TType extends "one-to-many" | "many-to-many" ? ManyRelation<EntityInstance<E>> : EntityInstance<E> : TType extends "one-to-many" | "many-to-many" ? RelationQueryBuilder<any> & EntityBase[] : EntityBase : never;
...
// @public
export type RelationQueryable<R> = R extends RelationDef<infer E, infer TType> ? E extends AnyEntityClass ? RelatedEntityInstance<E, RelationKind<TType>> : TType extends "one-to-many" | "many-to-many" ? RelationQueryBuilder<E> & E[] : RelationQueryBuilder<E> & E : never;
...
// @public
export type Row<TShape extends Record<string, unknown>, TRels extends RelationsMap = {}> = Flatten<MaterializeShape<TShape> & {
...
//
// @public
export type SelectRow<E extends AnyEntityClass> = E extends new (...args: any[]) => infer R ? R extends EntityBase ? R : SelectRowFromTable<E> : SelectRowFromTable<E>;
...
// @public
export type SQLToTS<S extends string> = ExtractSQLBase<S> extends keyof SQLTypeMap ? SQLTypeMap[ExtractSQLBase<S>] : unknown;
...
// @public
export interface TableDef<TSchema extends Record<string, string>, TRelations extends RelationsMap = Record<string, never>> {
